...
public class VistaVentas extends JPanel{
	...
	JButton cargar, nuevo, borrar, guardar,editar;
	...
	private void agregarBotones() {
		...
		cargar.setBorder(BorderFactory.createCompoundBorder(
			new CustomeBorder(), 
			new EmptyBorder(new Insets(15, 25, 15, 25))));
		...
		nuevo.setBorder(BorderFactory.createCompoundBorder(
			new CustomeBorder(), 
			new EmptyBorder(new Insets(15, 25, 15, 25))));
		...
		borrar.setBorder(BorderFactory.createCompoundBorder(
			new CustomeBorder(), 
			new EmptyBorder(new Insets(15, 25, 15, 25))));
