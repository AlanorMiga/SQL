...
public class VistaVentas extends JPanel {
	...
	JButton cargar, nuevo, borrarFila, borrar, salir, editar;
	...
	private void agregarBotones() {
		...
		salir.setBackground(Color.decode("#038aff"));
	...
	public void asignarListeners(EscuchaVentas listener) {
		...
		salir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog((JButton) e.getSource(), "Seguro que quieres cerrar sesion?");
